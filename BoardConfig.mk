...
TARGET_RECOVERY_INITRC := device/samsung/n8000/recovery.rc

TARGET_SPECIFIC_HEADER_PATH := device/samsung/n8000/overlay/include
...
# Graphics
BOARD_EGL_CFG := device/samsung/n8000/configs/egl.cfg
...
# Recovery
#BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/n8000/recovery/recovery_keys.c
BOARD_CUSTOM_GRAPHICS := ../../../device/samsung/n8000/recovery/graphics.c
...
# assert
TARGET_OTA_ASSERT_DEVICE := m0,n8000,GT-N8000
